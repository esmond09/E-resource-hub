...

{
  ...
  {  
	...
	else
	{
      ...
      $insert="INSERT INTO `book`(`b_id`,`booksname`,`authorname`,`programme`,`file_name`,`path`) VALUES('".$id."','".$bookname."','".$authorname."','".$programme."','".$new_file_name."','".$fpath."')";
...
<body>
  <div class="box">
   <table  style ="border-color:red; font-size:16pt"  align="center" width="100%" height="100%">
      ...
      <tr>
        <td style="color:antiquewhite;background-color: maroon" align="center"><b><i>Add Books to Database</i></b></td>
      </tr>
    </table>
  </div>
<div class="nav">
<ul>
  ...
  <li ><a href = "add_book.php"  style="background-color:dimgray">Add Book</a></li>
